      ...
      <Tabs defaultActiveKey="1" centered>
        ...
        <TabPane tab="Quy định công ty" key="3">
          ...
          <p>- Nhân viên phải tuân thủ nội quy làm việc, bảo vệ bí mật kinh doanh.Nhằm đảm bảo môi trường làm việc chuyên nghiệp, hiệu quả và bảo vệ các lợi ích kinh doanh, tất cả nhân viên phải tuân thủ nội quy làm việc và bảo vệ bí mật kinh doanh của công ty.
              ...
              Nhân viên phải tuân thủ giờ giấc làm việc theo quy định của công ty.
              
              Thực hiện công việc theo đúng chức năng, nhiệm vụ được giao, đảm bảo tiến độ và chất lượng công việc.
              
              Giữ gìn môi trường làm việc gọn gàng, sạch sẽ, tôn trọng đồng nghiệp và tuân thủ các quy định về an toàn lao động.
              
              Không sử dụng tài sản công ty vào mục đích cá nhân nếu chưa được phép.
              
              Hành xử chuyên nghiệp, trung thực, có trách nhiệm trong công việc và trong mọi giao dịch với khách hàng, đối tác.
              
              2. Bảo vệ bí mật kinh doanh
              
              Nhân viên không được tiết lộ, chia sẻ hoặc sử dụng trái phép các thông tin kinh doanh của công ty, bao gồm dữ liệu khách hàng, chiến lược kinh doanh, tài chính và công nghệ.
              
              Chỉ sử dụng thông tin nội bộ cho mục đích công việc và không được phép sao chép, lưu trữ hoặc chuyển giao thông tin ra bên ngoài nếu không có sự phê duyệt của cấp quản lý.
              
              Khi nghỉ việc hoặc chấm dứt hợp đồng lao động, nhân viên phải bàn giao toàn bộ tài liệu, thiết bị liên quan đến công ty và cam kết không tiết lộ thông tin bí mật cho bên thứ ba.
              
              Vi phạm các quy định về bảo mật có thể dẫn đến kỷ luật, chấm dứt hợp đồng lao động hoặc chịu trách nhiệm trước pháp luật.
              
              3. Chế tài xử lý vi phạm
              
              Nhân viên vi phạm nội quy làm việc hoặc quy định bảo mật có thể bị xử lý kỷ luật từ cảnh cáo đến buộc thôi việc, tùy theo mức độ vi phạm.
              
              Trường hợp gây thiệt hại nghiêm trọng, công ty có quyền yêu cầu bồi thường và áp dụng các biện pháp pháp lý cần thiết.
              
              4. Cam kết thực hiện
              
              Mọi nhân viên khi làm việc tại công ty đều phải đọc, hiểu và ký cam kết tuân thủ các nội quy và quy định bảo mật này.
              
              Công ty khuyến khích nhân viên đóng góp ý kiến để hoàn thiện hơn quy trình làm việc và các chính sách bảo mật.
              
              Việc tuân thủ nội quy làm việc và bảo vệ bí mật kinh doanh không chỉ đảm bảo lợi ích cho công ty mà còn giúp nhân viên phát triển chuyên nghiệp, tạo môi trường làm việc an toàn và bền vững.
              
              </p>
          <p>- Mọi vi phạm sẽ được xử lý theo quy định của công ty.Nhằm đảm bảo môi trường làm việc chuyên nghiệp, công bằng và hiệu quả, công ty ban hành quy định xử lý vi phạm đối với mọi hành vi vi phạm nội quy, quy chế làm việc và cam kết bảo mật. Tất cả nhân viên, đối tác phải tuân thủ các quy định này.

            1. Các hành vi vi phạm
            
            Vi phạm nội quy làm việc: đi trễ, bỏ việc không lý do, không hoàn thành công việc được giao.
            
            Vi phạm quy tắc đạo đức nghề nghiệp: gian lận, không trung thực trong công việc.
            
            Tiết lộ, sử dụng trái phép thông tin nội bộ hoặc bí mật kinh doanh của công ty.
            
            Sử dụng tài sản công ty vào mục đích cá nhân khi chưa được cấp phép.
            
            Gây ảnh hưởng tiêu cực đến hình ảnh, uy tín của công ty.
            
            Không tuân thủ quy trình an toàn lao động và quy định về bảo mật.
            
            2. Các hình thức xử lý vi phạm
            
            Nhắc nhở, cảnh cáo: Áp dụng với các vi phạm lần đầu hoặc mức độ nhẹ.
            
            Kỷ luật nội bộ: Khiển trách, phạt hành chính hoặc đình chỉ công tác trong thời gian nhất định.
            
            Chấm dứt hợp đồng lao động: Đối với các vi phạm nghiêm trọng hoặc tái phạm nhiều lần.
            
            Truy cứu trách nhiệm pháp lý: Trường hợp vi phạm gây thiệt hại lớn cho công ty hoặc vi phạm pháp luật, công ty có quyền yêu cầu bồi thường và áp dụng biện pháp pháp lý theo quy định.
            
            3. Quy trình xử lý vi phạm
            
            Khi phát hiện vi phạm, bộ phận có liên quan sẽ tiến hành điều tra, thu thập bằng chứng và lập biên bản.
            
            Nhân viên hoặc bên vi phạm sẽ được thông báo và có quyền giải trình trước khi công ty đưa ra quyết định xử lý.
            
            Kết quả xử lý sẽ được thông báo chính thức bằng văn bản.
            
            4. Cam kết thực hiện
            
            Tất cả nhân viên và đối tác cần tuân thủ quy định xử lý vi phạm này.
            
            Công ty khuyến khích sự trung thực, tinh thần trách nhiệm trong công việc và đảm bảo mọi quyết định xử lý vi phạm được thực hiện công bằng, minh bạch.
            
            Mọi vi phạm sẽ được xử lý nghiêm minh theo quy định của công ty nhằm bảo vệ lợi ích chung và duy trì môi trường làm việc chuyên nghiệp.
            
            </p>
          <p>- Chính sách về văn hóa doanh nghiệp, đạo đức nghề nghiệp và quyền lợi lao động.Nhằm xây dựng một môi trường làm việc chuyên nghiệp, công bằng và bền vững, công ty ban hành chính sách về văn hóa doanh nghiệp, đạo đức nghề nghiệp và quyền lợi lao động. Tất cả nhân viên và các bên liên quan đều có trách nhiệm tuân thủ các quy định này.

                1. Văn Hóa Doanh Nghiệp
                
                Công ty đề cao tinh thần hợp tác, tôn trọng lẫn nhau và làm việc chuyên nghiệp.
                
                Khuyến khích sự sáng tạo, đổi mới và không ngừng nâng cao hiệu suất công việc.
                
                Duy trì môi trường làm việc thân thiện, hòa đồng và hỗ trợ phát triển kỹ năng cho nhân viên.
                
                Đề cao sự minh bạch, trách nhiệm và tính trung thực trong mọi hoạt động kinh doanh.
                
                2. Đạo Đức Nghề Nghiệp
                
                Nhân viên phải làm việc với tinh thần trách nhiệm cao, tuân thủ pháp luật và các quy định của công ty.
                
                Không có hành vi gian lận, tham nhũng, cạnh tranh không lành mạnh hoặc làm tổn hại đến uy tín của công ty.
                
                Bảo mật thông tin nội bộ, không tiết lộ bí mật kinh doanh hoặc dữ liệu khách hàng cho bên thứ ba nếu không được cấp phép.
                
                Cư xử đúng mực, tôn trọng đồng nghiệp, khách hàng và đối tác trong mọi giao dịch.
                
                3. Quyền Lợi Lao Động
                
                Nhân viên được hưởng đầy đủ các quyền lợi theo quy định của pháp luật lao động, bao gồm lương, thưởng, bảo hiểm và chế độ nghỉ phép.
                
                Đảm bảo môi trường làm việc an toàn, lành mạnh và không có sự phân biệt đối xử.
                
                Cung cấp cơ hội đào tạo, phát triển nghề nghiệp và thăng tiến dựa trên năng lực làm việc.
                
                Khuyến khích và bảo vệ quyền lợi của người lao động trong mọi hoạt động của công ty.
                
                4. Cam Kết Thực Hiện
                
                Tất cả nhân viên và đối tác của công ty đều phải tuân thủ các chính sách này.
                
                Công ty cam kết xử lý nghiêm các hành vi vi phạm, đảm bảo công bằng và minh bạch trong môi trường làm việc.
                
                Thường xuyên cập nhật và cải thiện chính sách nhằm đáp ứng nhu cầu phát triển của công ty và nhân viên.
                
                Việc thực hiện chính sách về văn hóa doanh nghiệp, đạo đức nghề nghiệp và quyền lợi lao động sẽ góp phần xây dựng một tổ chức vững mạnh, phát triển bền vững và đảm bảo lợi ích chung cho tất cả các bên liên quan.</p>
        </TabPane>
